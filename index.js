...
function OrderNodes(inputs){
    inputs.forEach(input=>{
        orderedNodes[input.id]= Object.assign(new Node(input.id),{parent_id:null}, input,orderedNodes[input.id]);                    // Initialize Current Node and assign input {id,name,parent_id}
